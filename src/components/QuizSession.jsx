...
import { generateQuiz, generateWeakQuiz } from '../utils/quiz'
import { allGrammar, grammarByLevel } from '../data'

export default function QuizSession({ selectedLevels, progress, quizCount, weakMode, onRecord, onFinish }) {
  const pool = useMemo(() => {
  ...
  return (
    <div className="quiz-session">
      <div className="quiz-progress">
        ...
        {weakMode && <span className="weak-mode-badge">弱點加強</span>}
